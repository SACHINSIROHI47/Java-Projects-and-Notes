<%-- 
    Document   : ShareTransactionReport
    Created on : Feb 14, 2014, 7:36:07 PM
    Author     : chaudhary
--%>
...
function printpage()
  ...
  window.print()
    ...
    <table>
        ...
        <p align="center"><b>Company</b><select  name="" size="1" width="50" ></select></p>
...
<p align="center"><input type="button" value="Print" onclick="printpage()"></p>
