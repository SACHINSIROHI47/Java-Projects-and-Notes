<%-- 
    ...
    Created on : Feb 23, 2014, 12:35:19 PM
    Author     : chaudhary
--%>
...
function validate() {
 ...
 var str=/^[A-Za-z][.A-Za-z ]{0,100}$/;
   ...
   if((trim(document.form.id.value)=="") || str.test(trim(document.form.id.value))==false)
    ...
    <form onsubmit="return validate()" validate="true" method="post" name="form" >
...
<br>
        ...
        <p align="middle" border="1" height="100" width="100">
            <font size="+2" color="brown">COMPANY LOGIN</font></br><br>
...
try
    {
     ...
     ResultSet rs=st.executeQuery("select loginname,password from CompanyRegistration where loginname='"+uname+"' and password='"+pass+"' ");

          while(rs.next())
         {
         String uname2=rs.getString("loginname");
            ...
            if(uname.equals(uname2) && pass.equals(pass2))
             {
                ...
                %><jsp:forward page="EditCompanyInfo.jsp" /><%
             }
             else
             {
