<%-- 
    Document   : ChangePasswordInfo
    Created on : Mar 12, 2014, 2:33:47 PM
    Author     : 6
--%>
    ...
    <table>
        ...
        <TR>
         <td align="middle" valign="centre" width="10%"  bgcolor="BLACK">
                 <marquee behavior="alternate" scrollamount="3"><font size="5" color="white"><B>Welcome to Registration Zone</B></font></MARQUEE>
...
<table>
    <tr>
        ...
        <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp <a href="ChangeUserPassword.jsp"><font size="5" color="black">ChangeUserLoginPassword</font>
                </a><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp <a href="ChangeCompanyPassword.jsp"><font size="5" color="black">ChangeCompanyLoginPassword</font>
       </a>
        </p>
