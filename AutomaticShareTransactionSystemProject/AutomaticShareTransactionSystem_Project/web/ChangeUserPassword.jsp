<%-- 
    ...
    Created on : Mar 7, 2014, 3:19:06 PM
    Author     : 6
--%>
...
<br>
<p align="center"><font size="+2" color="brown">Change User Password:</font></p>
...
try
    ...
    if((uname.equals("null") || uname.toString()=="") ||  (pass.equals("null") || pass.toString()=="") || (npass.equals("null") || npass.toString()==""))
     ...
     int i=st.executeUpdate("update UserRegistration set password='"+npass+"' where username='"+uname+"' and password='"+pass+"' ");

      if(i!=0)
      {
           %>
       <center><font size="5" color="green"><%out.println("User Password has been change successfully.."); %></font></center>
         <%
      }
      else
      {
       %>
        <center><font size="5" color="red"><%out.println("User Password has not been change successfully.."); %></font></center>
       <%
      }
     }
   }
