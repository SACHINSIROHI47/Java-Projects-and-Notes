<%-- 
    Document   : ChangeCompanyPassword
    Created on : Mar 7, 2014, 3:25:31 PM
    Author     : 6
--%>
   ...
   if((trim(document.form.Login.value)=="") || str.test(trim(document.form.Login.value))==false)
	...
	return false;
   ...
   else if((trim(document.form.npwd.value)==""))
        {
         ...
         {
         alert("The length of the New password should not less than four.");
         document.form.npwd.focus();
         return false;
          }
...
<br>
<p align="center"><font size="+2" color="brown">Change Company Password:</font></p>
...
try
    ...
    if((uname.equals("null") || uname.toString()=="") ||  (pass.equals("null") || pass.toString()=="") || (npass.equals("null") || npass.toString()==""))
     ...
     int i=st.executeUpdate("update CompanyRegistration set password='"+npass+"' where companyname='"+uname+"' and password='"+pass+"' ");

      if(i!=0)
      {
           %>
        <center><font size="5" color="green"><%out.println("Company Password has been change successfully.."); %></font></center>
         <%
      }
      else
      {
       %>
        <center><font size="5" color="red"><%out.println("Company Password has not been change successfully.."); %></font></center>
       <%
      }
