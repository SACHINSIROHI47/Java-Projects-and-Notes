<%-- 
    Document   : RejectedCompanyRegistration
    Created on : Mar 7, 2014, 2:39:57 PM
    Author     : 6
--%>
...
function validate()
{
 ...
 var str=/^[A-Za-z][.A-Za-z ]{0,100}$/;
       ...
       var chge="Are you sure you want to reject company registration!";
...
<table align="center">
    <tr>
        <td><font color="green" size="5"><b>Reject Company Registration </b></font></td></tr>
 ...
 <br>
  <table align="center">
    <tr>
        <td>
    Enter Company Name: <input type="text" name="t1">
 ...
 try
     ...
     int i=st.executeUpdate("delete CompanyRegistration where companyname='"+uname+"'");
        if(i!=0)
         {
         %>
        <center><font size="5" color="green"><%out.println("Company Registration has been Rejected.."); %></font></center>
         <%
         }
        else
         {
          %>
         <center> <font size="5" color="red"><%out.println("Company Registration has not been Rejected.."); %></font></center>
         <%
         }
        }
      }
