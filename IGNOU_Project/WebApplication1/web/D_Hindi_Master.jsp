...
<td colspan="2" height="10%><p align="center"><font size="+2"><marquee behaviour="alteration">Welcome To School of Hindi Master</marquee> </font></p>
</td>
</tr>
</tbody>
</table>
 ...
 <table><tr >
    ...
    <table>
        <tr>
       <td>
           <font size="+2" color="blue"> <b>School of Humanities (SOH)	</b></font>
       </td>
</tr>
</table>
    ...
    <br>
            ...
            <div>
 	  	  ...
 	  	  <h2>
			  Master of Arts (Hindi)  (MHD)			  </h2>
			  
              <p><b>Minimum Duration:</b> 2  Years<br>
<b>Maximum Duration:</b> 5   Years<br>
				<b>Course Fee:</b> Rs. 9,000<br>
			<b>Minimum Age:</b> No bar <br>	
<b>Maximum Age:</b> No bar <br>					
<br>
<b>Eligibility:</b></p><p>Bachelor's Degree or a higher degree from a recognised University.</p><p></p>
</div>
