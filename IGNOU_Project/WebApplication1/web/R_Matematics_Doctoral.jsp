...
<td colspan="2" height="10%><p align="center"><font size="+2"><marquee behaviour="alteration">Welcome To School of Philosophy in Mathematics</marquee> </font></p>
</td>
</tr>
</tbody>
</table>
 ...
 <table><tr >
    ...
    <table>
        <tr>
       <td>
           <font size="+2" color="blue"> <b>School of Sciences (SOS)</b></font>
       </td>
</tr>
</table>
    ...
    <br>
 	  ...
 	  <h2>
			  Doctor of Philosophy in Mathematics  (PhD in Mathematics)			  </h2>
...
<div>&nbsp;</div>
<div>A candidate with an MPhil Degree in the relevant discipline, with minimum&nbsp;fifty-five&nbsp;percent marks (fifty percent marks for SC/ST/PH candidates) or an equivalent grade from a recognised university or an institution of higher learning need not undertake the course work.</div>
<div>&nbsp;</div>
<div><strong>Note: Course fee of Rs 7,000 is per year.</strong></div><p></p>
</div>
