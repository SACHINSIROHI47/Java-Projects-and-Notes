...
public final class dowlloadstudentdetails1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String rg2=request.getParameter("txt2");
     ...
     ResultSet rs=st.executeQuery("select reg from reg_tion");
        

     while(rs.next())
         {
         String regtt=rs.getString(1);
                out.println(regtt);
                out.println(rg2);      
      ...
      out.write("             ");
      if (true) {
        _jspx_page_context.forward("studentdwn.jsp");
        return;
      }
      out.write("\n");
      out.write("            \n");
