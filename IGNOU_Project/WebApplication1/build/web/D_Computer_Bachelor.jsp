...
<b>Maximum Duration:</b> 6   Years<br>
				<b>Course Fee:</b> Rs. 30,000<br>
			<b>Minimum Age:</b> No bar <br>	
<b>Maximum Age:</b> No bar <br>					
<br>
<b>Eligibility:</b></p><p class="MsoNormal">10+2 or its equivalent.
<strong>Course Fee: </strong>Rs. 5000/- For Ist Semester(Rs. 100 in addition to Rs. 5000 as Registration charges) and Rs. 5000/- Per Semester for Second Semester Onwards( See Common Prospectus for latest update)</p>
<p class="MsoNormal">&nbsp;</p>
<p>For admission related information, <br>
contact to Student Support Centre Ph. 011-29572513<br>
Email: ssc@ignou.ac.in<br>
&nbsp;</p><p></p>
</div>
