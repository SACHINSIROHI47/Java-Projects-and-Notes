...
private JMenuBar mb;
private JMenu m_aboutus, m_personal, m_saving, m_current, m_trans, m_Account, m_Cash, m_view;
private JMenuItem mi_profile, mi_vision, mi_open_saving, mi_saving, mi_open_current, mi_current, mi_cdeposit, mi_cwithdraw, mi_Ssaving, mi_Ccurrent, mi_SignUp, mi_exit;
private JPanel p1;
...
mi_SignUp = new JMenuItem("Sign Up Form");
...
m_personal.add(mi_SignUp);
mi_SignUp.addActionListener(this);
...
{
	//PrintSaving ps = new PrintSaving();
	//ps.launchFrame();
	//f.setVisible(false);
}
...
{
	//PrintCurrent pc = new PrintCurrent();
	//pc.launchFrame();
	//f.setVisible(false);
}
