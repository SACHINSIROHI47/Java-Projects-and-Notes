...
public class CurrentCashDetails implements ActionListener, WindowListener
{
	Connection con;
	Statement stmt;
...
public CurrentCashDetails()
{
f = new JFrame("Cash Details");
p1 = new JPanel();

lb_heading = new JLabel("Cash Details of Current Account");
...
f.setVisible(true);
	...
	public void windowOpened(WindowEvent e)
	{
		...
		try
		{
			...
			rs = stmt.executeQuery("Select Account_No from CurrentAc");
