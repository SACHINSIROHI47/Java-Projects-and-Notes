...
public final class tab_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <span href=\"#tab-item-2\">Calendar</span>\n");
      out.write("\n");
      out.write("  <input type=\"radio\" id=\"tab-3\" name=\"tab\">\n");
      out.write("  <span href=\"#tab-item-3\">Book Mark</span>\n");
      out.write("\n");
      out.write("  <input type=\"radio\" id=\"tab-4\" name=\"tab\">\n");
      out.write("  <span href=\"#tab-item-4\">Upload</span>\n");
      out.write("  \n");
      out.write("  <input type=\"radio\" id=\"tab-5\" name=\"tab\">\n");
      out.write("  <span href=\"#tab-item-5\">Settings</span>\n");
      out.write("\n");
      out.write("  \n");
      out.write("</div>\n");
      out.write("        <script>\n");
      out.write("      $(document).ready(function() {\n");
      out.write("  var oldId = null;\n");
      out.write("\n");
      out.write("  $('.tabs-controls__link').click(function(e) {\n");
      out.write("    e.preventDefault();\n");
      out.write("\n");
      out.write("    if ($(this).hasClass('tabs-controls__link--active')) {\n");
      out.write("      return false;\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    var currentId = parseInt($(this).data('id'), 10);\n");
      out.write("    $('.tabs-controls__link--active').removeClass('tabs-controls__link--active');\n");
      out.write("    $(this).addClass('tabs-controls__link--active');\n");
      out.write("\n");
      out.write("    if (currentId < oldId) { // item is hidden\n");
      out.write("      var timing = $('.card.hidden').length * 100;\n");
      out.write("      $('.card').each(function(index) {\n");
      out.write("        if (index > (currentId - 1 ) || index == (currentId - 1)) {\n");
      out.write("          window.setTimeout(function() {\n");
      out.write("            $('.card').eq(index).removeClass('hidden');\n");
      out.write("          }, timing - (index * 100));\n");
      out.write("        }\n");
      out.write("      });\n");
      out.write("    } else {\n");
      out.write("      $('.card').each(function(index) {\n");
      out.write("        if (index < (currentId - 1)) {\n");
      out.write("          window.setTimeout(function() {\n");
      out.write("            $('.card').eq(index).addClass('hidden');\n");
      out.write("          }, index * 100);\n");
      out.write("        }\n");
      out.write("      });\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    oldId = currentId;\n");
      out.write("  });\n");
      out.write("});      \n");
      out.write("</script>\n");
      out.write("    </body>\n");
